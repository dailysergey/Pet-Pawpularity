...
# page config
st.set_page_config(page_title            = "Score your pet!", 
                   page_icon             = "🐾", 
                   layout                = "centered", 
...
# description
st.write("This app uses deep learning to estimate a pawpularity score of custom pet photos. Pawpularity is a metric used by [PetFinder](https://petfinder.my/) to judge the pet's attractiveness, which translates to more clicks for the pet profile.")
...
if st.button('Compute pawpularity'):
    ...
    if pet_image is None:
        ...
        with st.spinner('Computing prediction...'):
            ...
            percent = np.round(percentileofscore(oof["pred"].values * 100, score), 2)
            ...
            col2.write('**Note:** pawpularity ranges from 0 to 100. Scroll down to read more about the metric and the implemented models.')
