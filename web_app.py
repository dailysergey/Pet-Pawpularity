...
cover_image = Image.open(requests.get(
    "https://storage.googleapis.com/kaggle-competitions/kaggle/25383/logos/header.png?t=2021-08-31-18-49-29", stream=True).raw)
...
# privacy toogle
choice = st.radio("2. Make the result public?", [
                  "Yes. Others may see your pet photo.", "No. Scoring will be done privately."])
...
if st.button('Compute pawpularity'):
    ...
    if pet_image is None:
        ...
        if model_name == 'EfficientNet B3':
            ...
            weight_path = 'https://github.com/dailysergey/Pet-Pawpularity/releases/download/model-weights/enet_b5.pth'
        ...
        with st.spinner('Computing prediction...'):
            ...
            percent = np.round(percentileofscore(
                oof["pred"].values * 100, score), 2)
            ...
            if choice == "Yes. Others may see your pet photo.":
                ...
                row = pd.DataFrame({"path": [example_path], "score": [
